    ...
    <section className="relative h-[700px] bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="grid lg:grid-cols-2 gap-8 items-center h-[calc(700px-10rem)]">
          ...
          {/* Right Column - Cards Grid with Individual Circular Animations */}
          <div className="lg:col-span-1 relative">
            
            {/* Card 1 - Top Left - Circular motion maintaining horizontal orientation */}
            <div className="absolute top-0 left-0 origin-center animate-[spin_20s_linear_infinite]">
              <Card className="w-80 h-48 bg-gradient-to-br from-blue-500 to-purple-600 border-none text-white overflow-hidden transform hover:scale-105 transition-all duration-300 animate-fade-in hover:shadow-2xl animate-[spin_20s_linear_infinite_reverse]">
            ...
            {/* Card 2 - Top Right - Circular motion maintaining horizontal orientation */}
            <div className="absolute top-8 right-0 origin-center animate-[spin_25s_linear_infinite]">
              <Card className="w-72 h-40 bg-white border-none text-black overflow-hidden transform hover:scale-105 transition-all duration-300 animate-fade-in hover:shadow-2xl animate-[spin_25s_linear_infinite_reverse]" style={{ animationDelay: '0.2s' }}>
                <CardContent className="p-0 relative h-full">
                  <img 
            ...
            {/* Card 3 - Bottom Left - Circular motion maintaining horizontal orientation */}
            <div className="absolute bottom-16 left-12 origin-center animate-[spin_30s_linear_infinite]">
              <Card className="w-64 h-44 bg-gradient-to-br from-purple-600 to-pink-600 border-none text-white overflow-hidden transform hover:scale-105 transition-all duration-300 animate-fade-in hover:shadow-2xl animate-[spin_30s_linear_infinite_reverse]" style={{ animationDelay: '0.4s' }}>
                <CardContent className="p-0 relative h-full">
                  <img 
            ...
            {/* Card 4 - Bottom Right - Circular motion maintaining horizontal orientation */}
            <div className="absolute bottom-0 right-8 origin-center animate-[spin_18s_linear_infinite]">
              <Card className="w-72 h-52 bg-gray-100 border-none text-black overflow-hidden transform hover:scale-105 transition-all duration-300 animate-fade-in hover:shadow-2xl animate-[spin_18s_linear_infinite_reverse]" style={{ animationDelay: '0.6s' }}>
                <CardContent className="p-0 relative h-full">
                  <img 
