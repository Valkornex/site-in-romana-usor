...
const BlogSection = () => {
  ...
  if (isLoading) {
    return (
      <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50" aria-label="Se încarcă articolele din blog">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-center" role="status" aria-live="polite">
            <Loader2 className="h-8 w-8 animate-spin mr-2 text-blue-600" aria-hidden="true" />
  ...
  if (error || displayArticles.length === 0) {
    return (
      <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50" aria-label="Eroare la încărcarea articolelor">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent mb-6">
              Ultimele Articole din Blog
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50" aria-label="Ultimele articole din blog">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent mb-6">
            Ultimele Articole din Blog
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {displayArticles.map((article, index) => (
            <Card 
              key={article.id} 
              className="group relative bg-white hover:bg-gradient-to-br hover:from-white hover:to-blue-50/50 border-0 shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer transform hover:-translate-y-3 overflow-hidden rounded-2xl"
              style={{
            ...
            >
              ...
              >
                ...
                <CardHeader className="px-6 pb-4">
                  <CardTitle className="text-xl font-bold text-gray-900 group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300 line-clamp-2 leading-tight">
                    {article.title}
                  </CardTitle>
                ...
                <CardContent className="px-6 pb-6">
                  ...
                  <div className="flex items-center justify-between">
                    <Button 
                      variant="ghost" 
                      className="group/btn text-blue-600 hover:text-white hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 p-0 h-auto px-4 py-2 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl"
                    >
                      Citește pe ZF.ro
        ...
        <div className="text-center">
          <Link to="/blog">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 hover:from-blue-700 hover:via-purple-700 hover:to-blue-800 text-white px-10 py-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 font-semibold text-lg"
            >
